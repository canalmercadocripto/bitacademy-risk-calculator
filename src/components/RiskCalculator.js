            ...
            <div className="calculator-card results-panel">
              ...
              <div className="results-grid">
                <div className="result-item">
                  <div className="result-label">Tamanho da Posição</div>
                  <div className="result-value">{results.positionSize?.toFixed(6)} moedas</div>
                </div>
                
                <div className="result-item">
                  <div className="result-label">Valor Investido</div>
                  <div className="result-value">${results.positionValue?.toFixed(2)}</div>
                </div>
                
                <div className="result-item">
                  <div className="result-label">Risco (Loss)</div>
                  <div className="result-value danger">${results.riskAmount?.toFixed(2)}</div>
                </div>
                
                <div className="result-item">
                  <div className="result-label">Potencial (Gain)</div>
                  <div className="result-value highlight">${results.rewardAmount?.toFixed(2)}</div>
                </div>
              </div>

              {/* Risk Ratio */}
              <div className="risk-ratio-display">
                <div className="ratio-label">Risk/Reward Ratio</div>
                <div className="ratio-value">{results.riskRewardRatio?.toFixed(2)}:1</div>
                <div className="ratio-description">
                  {results.riskRewardRatio >= 2 ? 'Excelente ratio!' : 
