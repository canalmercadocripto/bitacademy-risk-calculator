...
📱 Generated by BitAcademy Risk Calculator
  ...
  return (
    <div className="enhanced-results">
      <div className="results-single-column">
            ...
            <div className="rr-section">
              ...
              <div className="rr-analysis-card">
                ...
                {displayResults.riskRewardRatio > 0 && (
                  <div className="win-rate-needed" style={{ marginTop: '6px', padding: '8px', background: 'rgba(255,255,255,0.1)', borderRadius: '6px', border: `1px solid ${calculateWinRateNeeded(displayResults.riskRewardRatio).classification.color}` }}>
                    ...
                    <div style={{ marginTop: '4px', fontSize: '0.65em', fontWeight: '600', color: calculateWinRateNeeded(displayResults.riskRewardRatio).classification.color }}>
